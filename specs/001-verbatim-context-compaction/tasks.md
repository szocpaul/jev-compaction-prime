...
- [ ] T001 Rögzíts ≥5 valós Prime Agent session-átiratot (JSONL) a `tests/fixtures/transcripts/` alá, változatlan környezetben; minden áirat 80–150 tool call-os legyen.
